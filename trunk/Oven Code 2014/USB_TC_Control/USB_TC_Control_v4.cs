...
namespace USB_TC_Control
{
    public partial class USB_TC_Control : Form
    {
        ...
        public static int temp_start_check = 0;
        ...
        public void StopThreads_AndCloseOvenProgram()
        {
            ...
            if (oven_start_check != 0 || temp_start_check != 0)
            {
            ...
            if (temp_start_check == 1 && read_check != 0)
            {
        ...
        public static int IsError(ErrorInfo error)
        {
        ...
        private void ReadTCbutton_Click(object sender, EventArgs e)
        {
            ...
            if (temp_start_check == 0 && oven_start_check == 0)
                resetboxes();
            ...
            if (temp_start_check == 0)
            {
                copy_parameters();

                temp_read_thread = new Thread(new ThreadStart(temp_reader));
        ...
        private void StartOvenButton_Click(object sender, EventArgs e)
        {
            ...
            if (is_parameters_changed() || 
                (temp_start_check == 1 && oven_start_check == 0)) 
            {
                update_directory();
                MessageBox.Show("Please double check all values, just to be " +
